...
def main():
    ...
    if len(stage8['badies']) != 0:
        ...
        stage9 = {'goodies': [],'badies': [], 'percentage_solved': stage8['percentage_solved'], 'time': 0.0}
    ...
    if len(stage9['badies']) != 0:
        ...
        stage10 = {'goodies': [],'badies': [], 'percentage_solved': stage9['percentage_solved'], 'time': 0.0}
    ...
    if len(stage10['badies']) != 0:
        ...
        stage11 = {'goodies': [],'badies': [], 'percentage_solved': stage10['percentage_solved'], 'time': 0.0}

    if len(stage11['badies']) != 0:
        stage12 = process_remainder(stage11['badies'], hmany, 'stage12', success)
        success = stage12['percentage_solved']
    else:
        stage12 = {'goodies': [],'badies': [], 'percentage_solved': stage11['percentage_solved'], 'time': 0.0}
