...
def main():
    ...
    stage2 = process_regrouping(stage1['badies'], hmany, len(cat), 2.25, 'stage2', best_dist, success)
    success = stage2['success']

    stage3 = process_regrouping(stage2['badies'], hmany, len(cat), 0.75, 'stage3', best_dist, success)
    ...
    stage5 = process_regrouping(stage4['badies'], hmany, len(cat), 0.47, 'stage5', best_dist, success)
    success = stage5['success']

    stage6 = process_regrouping(stage5['badies'], hmany, len(cat), 2.25, 'stage6', best_dist, success)
